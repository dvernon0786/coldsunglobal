    ...
    <>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="w-40 h-40 rounded-2xl flex items-center justify-center text-6xl font-bold text-white mb-8 shadow-2xl" style={{background:"linear-gradient(135deg, var(--navy) 0%, var(--navy-mid) 100%)",fontFamily:"Arial, Helvetica, sans-serif"}}>
                E
              </div>
              <p className="section-label mb-2">Founder & Principal Architect</p>
              <h2 className="text-4xl mb-2" style={{color:"var(--navy)",fontFamily:"Arial, Helvetica, sans-serif"}}>Erik</h2>
              <p className="text-orange-500 font-semibold mb-6" style={{fontFamily:"Arial, Helvetica, sans-serif"}}>Cold Sun Global / Cold Sun Capital</p>
              <div className="flex flex-wrap gap-3 mb-8">
                {["Salesforce Certified","NetSuite Specialist","IFS Cloud Architect","15+ Years FSM","150+ Implementations"].map(b => (
                  <span key={b} className="text-xs font-semibold px-3 py-1.5 rounded-full border" style={{borderColor:"var(--navy)",color:"var(--navy)",fontFamily:"Arial, Helvetica, sans-serif"}}>{b}</span>
                ))}
              </div>
            </div>
            <div>
              <p className="text-gray-600 text-lg leading-relaxed mb-5" style={{fontFamily:"Arial, Helvetica, sans-serif"}}>
              ...
              <p className="text-gray-600 leading-relaxed mb-8" style={{fontFamily:"Arial, Helvetica, sans-serif"}}>
      ...
      <section className="py-20 px-6" style={{background:"var(--off-white)"}}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-600 text-lg mb-10" style={{fontFamily:"Arial, Helvetica, sans-serif"}}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={item.t} className="p-6 rounded-xl bg-white border border-gray-100 card-lift">
                <h3 className="font-bold mb-2" style={{color:"var(--navy)",fontFamily:"Arial, Helvetica, sans-serif"}}>{item.t}</h3>
