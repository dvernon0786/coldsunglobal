    ...
    <>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={item.t} className="p-5 rounded-xl border border-gray-100 bg-white card-lift">
                ...
                <p className="text-sm text-gray-500" style={{fontFamily:"'DM Sans',sans-serif"}}>{item.d}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={s.n} className="p-8 rounded-xl bg-white border border-gray-100 card-lift">
                <div className="text-4xl font-bold mb-4" style={{color:"var(--orange)",fontFamily:"'Playfair Display',serif",opacity:0.4}}>{s.n}</div>
                <h3 className="font-bold text-lg mb-3" style={{color:"var(--navy)",fontFamily:"'Playfair Display',serif"}}>{s.t}</h3>
                <p className="text-gray-500 text-sm leading-relaxed" style={{fontFamily:"'DM Sans',sans-serif"}}>{s.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6" style={{background:"var(--navy)"}}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl text-white mb-4" style={{fontFamily:"'Playfair Display',serif"}}>Ready to Deploy AI Agents Responsibly?</h2>
          <p className="text-white/70 text-lg mb-8" style={{fontFamily:"'DM Sans',sans-serif"}}>Book a complimentary AI readiness assessment with Erik. We&apos;ll identify your highest-value agent opportunities and design a governed rollout plan.</p>
